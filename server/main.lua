...
TriggerEvent('esx_phone:registerNumber', 'dadgostari', _U('alert_dadgostari'), true, true)
...
AddEventHandler('esx_dadgostari_job:handcuff', function(target)
	...
	if xPlayer.job.name == 'dadgostari' then
		TriggerClientEvent('esx_dadgostari_job:handcuff', target)
	else
...
AddEventHandler('esx_dadgostari_job:OutVehicle', function(target)
	...
	if xPlayer.job.name == 'dadgostari' then
		TriggerClientEvent('esx_dadgostari_job:OutVehicle', target)
	else
